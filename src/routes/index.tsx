...
const reviews = [
  {
    ...
    avatar: avatar1,
    rating: 5,
    text: "Comprei hoje de manhã e o código chegou de tarde no mesmo dia muito rápido 1000/10",
    time: "há 1 h",
  },
  {
    name: "@kaik_fzx🏄",
    avatar: avatar2,
    rating: 4,
    text: "Disseram que estava reepondo estoque e demorou quase um dia mas chego tudo certo 10/10",
    time: "há 38 min",
  },
  {
    name: "@yamalgoat72.",
    avatar: avatar3,
    rating: 5,
    text: "Muito barato, comprei com o vendedor pelo tiktok, muito rápido a entrega 100/10",
    time: "há 1 h",
  },
  {
    name: "@HATASHI.4x",
    avatar: avatar4,
    rating: 5,
    text: "Comprei 1000 robux pra testar e realmente chegou mas vou ter que esperar reabastecer o estoque porque acaba rápido 10/10",
    time: "há 2 h",
  },
  {
    name: "@Santx💯z_",
    avatar: avatar5,
    rating: 5,
    text: "Mais barato do mercado pode comprar sem medo 💯",
    time: "há 3 h",
  },
  {
    name: "@voltoem2025_",
    avatar: avatar6,
    rating: 4,
    text: "Chegou tudo certo mas quase eu esqueço de colocar o e-mail kkkk 10/10",
    time: "há 4 h",
  },
  {
    name: "@shaolinmatadordeporco2937",
    avatar: avatar7,
    rating: 5,
    text: "Único que não é golpe e tem preço de fornecedor 10000/10",
    time: "há 5 h",
  },
  {
    name: "@dutra09_🏄‍♂️",
    avatar: avatar8,
    rating: 5,
    text: "Recebi certin depois de pagar sem enrolação",
    time: "há 6 h",
  },
];
